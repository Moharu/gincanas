...
var extractTaskCategories = function extractTaskCategories(tasks) {
...
var TaskList = function (_React$Component) {
    ...
    _createClass(TaskList, [{
        ...
        value: function render() {
            ...
            var taskCategories = extractTaskCategories(this.props.tasks);
            ...
            return React.createElement(
                ...
                React.createElement(
                    'ul',
                    null,
                    taskCategories.map(function (category, i) {
                        console.log(category);
                        return React.createElement(
                            'li',
                            { style: filterStyle, key: i },
                            category
                        );
                    })
                ),
                    ...
                    this.props.tasks.map(function (task, i) {
                        return React.createElement(
                            ...
                            { key: i, onClick: function onClick() {
                                    _this2.props.onSelect && _this2.props.onSelect(i);
                                } },
                            task.title
                        );
                    })
...
var taskList = [{ title: '#01 Primeira', category: 'Esportiva', content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' }, { title: '#02 Segunda', category: 'Charada', content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' }, { title: '#03 Quarta!', category: 'Artística', content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.' }];

var TasksScreen = function (_React$Component) {
    _inherits(TasksScreen, _React$Component);

    function TasksScreen(props) {
        _classCallCheck(this, TasksScreen);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TasksScreen).call(this, props));
    ...
    _createClass(TasksScreen, [{
        key: 'onSelectTaskHandler',
        value: function onSelectTaskHandler(selectedTask) {
            this.setState({ selectedTask: selectedTask });
        }
    }, {
        key: 'render',
        value: function render() {
            var onSelectTaskHandler = this.onSelectTaskHandler.bind(this);
            var currentTask = taskList[this.state.selectedTask];
            return React.createElement(
                'div',
                null,
                React.createElement(_TaskList2.default, {
                    tasks: taskList,
                    onSelect: onSelectTaskHandler }),
                React.createElement(_Task2.default, currentTask)
            );
        }
    }]);
...
},{"./Task":168,"./TaskList":169,"react":167}],171:[function(require,module,exports){
'use strict';

var _TasksScreen = require('./components/TasksScreen');

var _TasksScreen2 = _interopRequireDefault(_TasksScreen);
...
var selectTask = function selectTask(i) {
...
ReactDOM.render(React.createElement(
  'div',
  null,
  React.createElement(_TasksScreen2.default, null)
), document.getElementById('content'));

},{"./components/TasksScreen":170,"react":167,"react-dom":29}]},{},[171]);
